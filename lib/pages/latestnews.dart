...
import 'package:flutter/services.dart'
    show ByteData, rootBundle; // Required for rootBundle
...
class _LatestnewsPageState extends State<LatestnewsPage>
  ...
  String?
      _lastSelectedMenuItemValue; // To store the value of the last tapped menu item
                          ...
                          child: Row(
                            children: [
                              Icon(
                                ...
                                color: _lastSelectedMenuItemValue ==
                                        'signup_signin'
                                    ? Colors.red
                                    : Colors.blue,
                                size: 20,
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        // Removed 'const' as GoogleFonts style is not constant
                        'Search for news articles...',
                        style: GoogleFonts.dancingScript(
                          fontSize: 19,
                          color: Colors
                              .white, // Note: Consider changing for better contrast
                          fontWeight: FontWeight.bold,
                        ),
              ...
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      // Changed Row to Column to accommodate multiple children
                      children: [
                        Row(
                          // First child: The original Row for news content
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.all(
                                        8.0), // Consider using GoogleFonts or default system font
                                    child: Text(
                                      '23rd September 2020',
                                      style: TextStyle(
                                        fontSize: 20,
                                        ...
                                        color:
                                            Color.fromARGB(255, 139, 193, 238),
                                      ),
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Text(
                                      // Consider using GoogleFonts or default system font
                          ...
                          child: Row(
                            children: [
                              ElevatedButton(
                                ...
                                child: const Text(
                                  // Consider default system font or GoogleFonts
                                  'Read More 👇',
                                  style: TextStyle(
                                    fontSize: 16,
                                ...
                                onPressed: () async {
                                  ...
                                  try {
                                    ...
                                    final String filePath =
                                        '$tempPath/${assetPath.split('/').last}'; // e.g., /data/user/0/.../your_document_name.pdf
                                    final File file = File(
                                        filePath); // Use the dynamically created filePath
                                    ...
                                    final OpenResult result = await OpenFile.open(
                                        filePath); // Use the same filePath to open
